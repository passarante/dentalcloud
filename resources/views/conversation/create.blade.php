        ...
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                ...
                <div class="card-body" id="bar-parent">
                    <form action="{{route('conversation.store')}}" id="form_sample_1" method="POST"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3">Görüşme Tarihi
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-5">
                                    <div class="input-group date form_date " data-date="" data-date-format="yyyy/mm/dd"
                                        data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        <input class="form-control input-height" size="16" placeholder="Görüşme Tarihi"
                                            id="conversationDate" type="text" value="" name="conversation_date">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3">Görüşme Türü
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-5">
                                    <select class="form-control input-height" name="conversation_type">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3">Görüşme Notu
                                </label>
                                <div class="col-md-5">
                                    <textarea name="message_body" class="form-control-textarea"
                                        placeholder="Görüşme Notu" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
