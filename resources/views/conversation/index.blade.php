  ...
  <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Görüşme Kayıtları</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Anasayfa</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="">Görüşme</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Görüşme Kayıtları</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                       ...
                                       <tbody>
                                           @foreach ($conversations as $key => $conversation)
	                                         <tr class="odd gradeX">
												...
												<td><a href="#">
														{{$conversation->full_name}} </a></td>

												<td class="center">{{$conversation->conversation_type}}</td>
                                                <td class="center">{{$conversation->message_body}}</td>
                                                	<td class="center">{{$conversation->status}}</td>
