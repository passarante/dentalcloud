...
<div class="page-content">
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title"><span class="text-danger">{{$patient->fullName}}</span> - PLANLANMIŞ TEDAVİ EKLEME</div>
...
for(var i=1; i < rowNumber; i++){
    ...
    $.post('/patient/treatment/addPTreatment',{patientId,date,note,teethNr,treatment},function(response){
