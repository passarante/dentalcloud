...
<div class="page-content">
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title"><span class="text-danger">{{$patient->fullName}}</span> - TEDAVİ EKLEME</div>
                ...
                <div class="card-body">
                    ...
                    <p>{{$patient->fullName}} için planlanmış tedavi bulunmamaktadır.
                                <span class="pull-right">
                                    Yeni Planlanmış Tedavi  bilgisi eklemek için <button class="btn btn-success">tıklayın </button>
                                </span>
...
<table id="patientDiagnoseListTable" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><button class="btn btn-danger" onClick="deleteDiagnose({{$diagnose->id}})">Sil</button></td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div>
        <p>{{$patient->fullName}} için henüz bir diagnoz bilgisi eklenmemiş.
            <span class="pull-right">
Yeni Diagnoz bilgisi eklemek için <button class="btn btn-success">tıklayın </button>
            </span>
...
for(var i=1; i < rowNumber; i++){
    ...
    $.post('/patient/treatment/addTreatment',{patientId,date,note,teethNr,treatment},function(response){
